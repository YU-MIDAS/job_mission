...
class SystemDecisionBuilderTest(unittest.TestCase):
    ...
    def test_product_planner_hard_decisions(self) -> None:
        ...
        self.assertEqual(decisions["difficulty"]["task_count_range"], [3, 3])
    ...
    def test_llm_input_and_prompt_include_mission_design(self) -> None:
        ...
        self.assertIn("exactly 1 provided material and exactly 1 task", prompts["user"])
        self.assertIn("exactly 2 provided materials and exactly 2 tasks", prompts["user"])
        self.assertIn("exactly 3 provided materials and exactly 3 tasks", prompts["user"])
